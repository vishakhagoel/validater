...
def check_owners(approvers, directory_path):
    ...
    #print("parent dir path: ", os.path.dirname(str(directory_path)))
    result = False
    if owners_data == None:                                         #if owners file in this directory doesn't exist check parent
...
def main():
    ...
    files_changed = ["src/com/twitter/user/User.java", "src/com/twitter/follow/Follow.java"]
